-- RLS smoke test for reminder.
-- Mirrors the schedule_item smoke pattern. Wraps in begin; rollback;
...
--      (protects reminder_update USING clause)
...
values
  ('11111111-1111-1111-1111-111111111111','00000000-0000-0000-0000-000000000000',
   'authenticated','authenticated','rem-author@test','', now(),
   '{}','{}', now(), now(), '','','','','',''),
  ('22222222-2222-2222-2222-222222222222','00000000-0000-0000-0000-000000000000',
   'authenticated','authenticated','rem-comember@test','', now(),
   '{}','{}', now(), now(), '','','','','',''),
  ('33333333-3333-3333-3333-333333333333','00000000-0000-0000-0000-000000000000',
   'authenticated','authenticated','rem-former@test','', now(),
   '{}','{}', now(), now(), '','','','','','');
...
savepoint sp1;
insert into reminder (id, circle_id, created_by_user_id, title, due_at)
values
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee',
   'cccccccc-cccc-cccc-cccc-cccccccccccc',
   '11111111-1111-1111-1111-111111111111',
   'Tandläkare', now() + interval '1 day');

\echo '---test 2: spoof author=stranger into own circle (expect RLS violation)---'
savepoint sp2;
insert into reminder (circle_id, created_by_user_id, title, due_at)
values
  ('cccccccc-cccc-cccc-cccc-cccccccccccc',
...
\echo '---test 4: former staff SELECTs reminder in circle A (expect 0 rows)---'
select set_config('request.jwt.claims',
