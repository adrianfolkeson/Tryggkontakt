...
insert into public.daily_update
  (id, circle_id, author_user_id, mood, sleep, energy, free_text)
values
  ('cccccccc-cccc-cccc-cccc-cccccccccccc',
   'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
   '22222222-2222-2222-2222-222222222222',
   'calm','good','medium','Update by staff_active'),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd',
   'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
   '11111111-1111-1111-1111-111111111111',
   'happy','okay','high','Update by relative'),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee',
   'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
   '33333333-3333-3333-3333-333333333333',
   'tired','poor','low','Update by staff_former while still active');
...
begin
  insert into public.daily_update
    (circle_id, author_user_id, mood, sleep, energy, free_text)
  values
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
     '11111111-1111-1111-1111-111111111111',
     'calm','good','high','Second relative update');
...
begin
  ...
  values
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
     '22222222-2222-2222-2222-222222222222',
     'happy','okay','medium','spoofed author');
...
begin
  ...
  values
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
     '33333333-3333-3333-3333-333333333333',
     'tired','poor','low','former trying to insert');
